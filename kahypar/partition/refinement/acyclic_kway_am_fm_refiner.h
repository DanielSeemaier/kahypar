...
public:
  AcyclicKWayAdvancedMovesFMRefiner(Hypergraph& hypergraph, const Context& context,
  ...
  void printSummary() const override {
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Number of calls:" << _num_calls;
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Number of moves:" << _num_moves;
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Number of rollbacks:" << _num_rollbacks;
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Number of refinement nodes that are border nodes:" << _num_border_refinement_nodes;
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Number of refinement nodes that are NOT border nodes:" << _num_non_border_refinement_nodes;
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Number of moves in the last iteration:" << _num_moves_in_last_iteration;
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Number of moves denied by the acyclic constrain:" << _num_moves_denied_by_acyclic_constrain;
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Number of moves denied by the balance constrain:" << _num_moves_denied_by_balance_constrain;
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Number of moves with positive gain:" << _num_positive_gain_moves;
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Number of moves with zero gain:" << _num_zero_gain_moves;
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Number of moves with negative gain:" << _num_negative_gain_moves;
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Improved KM1 by:" << _improved_km1;
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Total size of initial PQs:" << _initial_pq_size;
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Number of initially enabled PQs:" << _num_initially_enabled_pqs;
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Max part weights:" << _context.partition.max_part_weights[0];
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Perform moves time:" << _perform_moves_time;
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Refine time:" << _refine_time;
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Refine until best cut time:" << _actual_refine_time;
    LOG << "[AcyclicKWayAdvancedMovesFMRefiner] Gains time:" << _gain_time;
  }
